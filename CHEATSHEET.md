...
1. Hit **Submit & Export** in the toolbar.
2. If subtotal < $700, you'll get a warning. You can still export.
3. Confirm.
4. **Two files download** to your iPad (Files app, Downloads):
   - `sepet2026-filled-….pdf` — your filled order for submission
...
- Todd: (your phone) — text, don't call, if possible
- SEP booth rep: (their card)

## Shebang

**Minimum order $700. Orders ship Sept 15 – Oct 31. Cash-back deals must be redeemed at the booth.**
